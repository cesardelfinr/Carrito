  ...
  constructor(props) {
    ...
    this.state = {
      ...
      products: [
        {
          id: 1,
          name: 'Docena de Tequeños',
          picture: 'https://d1kxxrc2vqy8oa.cloudfront.net/wp-content/uploads/2018/12/30092825/RFB-0000-30-tequen%CC%83os.jpg',
          price: 20,
        ...
        {
          id: 2,
          name: 'Docena de Pastelitos',
          picture: 'https://d1kxxrc2vqy8oa.cloudfront.net/wp-content/uploads/2019/02/13133635/RFB-0502-1-pastelitoszulianos.jpg',
          price: 20,
          datails: 'Compra Protegida, recibe el producto que esperabas o te devolvemos tu dinero.',
          marca: 'Pollo',
          status: 20,
